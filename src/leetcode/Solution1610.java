...
public class Solution1610 {
    ...
    public int visiblePoints(List<List<Integer>> points, int angle, List<Integer> location) {
        ...
        //计算弧度，Math.atan2表示的范围是角度是-180到180，即-pi到pi，转成0到360,即0到2pi
        //同时计算与location重叠的点的数量
        int cnt = 0;
        ...
        //滑动窗口[i,j]内的点范围不超过视野弧度t
        //由于是环形遍历，窗口有部分是末尾，部分在前端的情况。复制一份接到末尾即可
        ...
        return cnt + max;//与location重叠的数量加上视野内的数量
    }
}
