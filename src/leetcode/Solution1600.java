...
public class Solution1600 {
    class ThroneInheritance {
        ...
        private List<String> getInheritanceOrder(Person person) {
            ...
            if(person==null)return inheritanceOrder;
            if(!person.dead)inheritanceOrder.add(person.name);
            for(Person c:person.children){
                inheritanceOrder.addAll(getInheritanceOrder(c));
            }
